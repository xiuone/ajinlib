...
class PreviewTitleBar : TitleBar {
    ...
    override fun setTitleBarStyle() {
        ...
        if (checkStyleValidity(titleBarStyle!!.previewTitleBackgroundColor)) {
            setBackgroundColor(titleBarStyle.previewTitleBackgroundColor)
        } else if (checkSizeValidity(titleBarStyle.titleBackgroundColor)) {
            setBackgroundColor(titleBarStyle.titleBackgroundColor)
        }
        if (checkStyleValidity(titleBarStyle.previewTitleLeftBackResource)) {
