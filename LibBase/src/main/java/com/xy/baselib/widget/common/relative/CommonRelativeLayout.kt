package com.xy.baselib.widget.common.relative
...
open class CommonRelativeLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet?=null, defStyleAttr:Int = 0) :
    RelativeLayout(context, attrs, defStyleAttr), CommonDrawListener,View.OnFocusChangeListener{
