...
import com.xy.baselib.widget.common.draw.BottomLineDrawImpl
import com.xy.baselib.widget.common.draw.CommonDrawImpl

open class BottomLineLinearLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet?=null, defStyleAttr:Int = 0) :
    LinearLayout(context, attrs, defStyleAttr), CommonDrawListener,View.OnFocusChangeListener{
    private val editBackDrawImpl by lazy { BottomLineDrawImpl(this,context) }
