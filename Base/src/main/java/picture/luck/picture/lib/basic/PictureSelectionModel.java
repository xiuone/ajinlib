...
import picture.luck.picture.lib.PictureSelectorFragment;
import xy.xy.base.R;
import picture.luck.picture.lib.animators.AnimationType;
import picture.luck.picture.lib.config.FileSizeUnit;
import picture.luck.picture.lib.config.PictureConfig;
...
import picture.luck.picture.lib.config.SelectorProviders;
import picture.luck.picture.lib.config.VideoQuality;
import picture.luck.picture.lib.engine.CompressEngine;
import picture.luck.picture.lib.engine.CompressFileEngine;
import picture.luck.picture.lib.engine.CropEngine;
import picture.luck.picture.lib.engine.CropFileEngine;
import picture.luck.picture.lib.engine.ExtendLoaderEngine;
import picture.luck.picture.lib.engine.ImageEngine;
import picture.luck.picture.lib.engine.SandboxFileEngine;
import picture.luck.picture.lib.engine.UriToFileTransformEngine;
import picture.luck.picture.lib.engine.VideoPlayerEngine;
import picture.luck.picture.lib.entity.LocalMedia;
import picture.luck.picture.lib.entity.LocalMediaFolder;
...
import picture.luck.picture.lib.interfaces.OnCustomLoadingListener;
import picture.luck.picture.lib.interfaces.OnGridItemSelectAnimListener;
import picture.luck.picture.lib.interfaces.OnInjectLayoutResourceListener;
import picture.luck.picture.lib.interfaces.OnMediaEditInterceptListener;
import picture.luck.picture.lib.interfaces.OnPermissionDeniedListener;
import picture.luck.picture.lib.interfaces.OnPermissionDescriptionListener;
import picture.luck.picture.lib.interfaces.OnPermissionsInterceptListener;
import picture.luck.picture.lib.interfaces.OnPreviewInterceptListener;
import picture.luck.picture.lib.interfaces.OnQueryFilterListener;
...
import picture.luck.picture.lib.interfaces.OnSelectAnimListener;
import picture.luck.picture.lib.interfaces.OnSelectFilterListener;
import picture.luck.picture.lib.interfaces.OnSelectLimitTipsListener;
import picture.luck.picture.lib.interfaces.OnVideoThumbnailEventListener;
import picture.luck.picture.lib.language.LanguageConfig;
import picture.luck.picture.lib.style.AlbumWindowStyle;
import picture.luck.picture.lib.style.BottomNavBarStyle;
import picture.luck.picture.lib.style.SelectMainStyle;
import picture.luck.picture.lib.style.TitleBarStyle;
...
import picture.luck.picture.lib.utils.DoubleUtils;
...
public final class PictureSelectionModel {
     ...
     *                {@link TitleBarStyle}
     *                {@link AlbumWindowStyle}
     *                {@link SelectMainStyle}
     *                {@link BottomNavBarStyle}
     *                {@link PictureWindowAnimationStyle}
     *                <p/>
