package xy.xy.base.widget.recycler.diver
...
import xy.xy.base.widget.recycler.adapter.RecyclerAdapterWrapper
...
open class DiverItemDecoration(verticalColor: Int = 0X00FFFFFF,val verticalHeight: Int,
    ...
    private fun getCurrentPosition(index:Int,adapter:RecyclerView.Adapter<*>):Int{
        val headSize = if (adapter is RecyclerAdapterWrapper<*>) adapter.getHeadSize() else 0
