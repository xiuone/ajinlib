package xy.xy.base.widget.bar.mswitch
...
class SwitchBarView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private val defaultGraColor by lazy { Color.GRAY }
    private val defaultWhiteColor by lazy { Color.WHITE }
    private val defaultBlueColor by lazy { Color.BLUE }
    //背景颜色
