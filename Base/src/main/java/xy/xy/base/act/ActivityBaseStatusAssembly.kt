...
abstract class ActivityBaseStatusAssembly : ActivityBaseStatus() , BaseAssemblyViewWithContext,
    ...
    protected val loadView by lazy { LayoutInflater.from(this).inflate(loadRes(),null) }
    protected val unNetView by lazy { LayoutInflater.from(this).inflate(unNetRes(),null) }
    protected val errorView by lazy { LayoutInflater.from(this).inflate(errorRes(),null) }
    protected val emptyView by lazy { LayoutInflater.from(this).inflate(emptyRes(),null) }


    val loadDialog by lazy { LoadProgressDialog(this, this) }
