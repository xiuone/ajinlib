...
import ucrop.yalantis.ucrop.callback.BitmapCropCallback;
import ucrop.yalantis.ucrop.model.AspectRatio;
import ucrop.yalantis.ucrop.statusbar.ImmersiveManager;
import ucrop.yalantis.ucrop.util.FileUtils;
import ucrop.yalantis.ucrop.util.SelectedStateListDrawable;
import ucrop.yalantis.ucrop.view.CropImageView;
import ucrop.yalantis.ucrop.view.GestureCropImageView;
import ucrop.yalantis.ucrop.view.OverlayView;
import ucrop.yalantis.ucrop.view.TransformImageView;
import ucrop.yalantis.ucrop.view.UCropView;
import ucrop.yalantis.ucrop.view.widget.AspectRatioTextView;
import ucrop.yalantis.ucrop.view.widget.HorizontalProgressWheelView;
import xy.xy.base.R;
