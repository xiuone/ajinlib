package com.xy.base.utils.record.record.recorder;
...
public class RecordService extends Service {
    ...
    private static String getFilePath() {
       ...
       String filepath = String.format(Locale.getDefault(), "%s%s%s", fileDir, fileName, currentConfig.getFormat().getExtension());
