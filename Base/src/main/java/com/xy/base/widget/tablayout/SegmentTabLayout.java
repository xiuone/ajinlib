...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextUnSelectSize = ta.getDimension(R.styleable.SegmentTabLayout_tl_textSelectSize, sp2px(13f));
        mTextSelectSize = ta.getDimension(R.styleable.SegmentTabLayout_tl_textSelectSize, mTextUnSelectSize);
