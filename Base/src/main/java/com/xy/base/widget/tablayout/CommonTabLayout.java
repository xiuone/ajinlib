...
import com.xy.base.widget.tablayout.listener.CustomTabEntity;
import com.xy.base.widget.tablayout.listener.OnTabSelectListener;
import com.xy.base.widget.tablayout.utils.FragmentChangeManager;
...
//    判断是否是减半颜色
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        isGradientColor = ta.getBoolean(R.styleable.CommonTabLayout_tl_indicator_gradient, false);
        mIndicatorStartColor = ta.getInt(R.styleable.CommonTabLayout_tl_indicator_start_color, 0);
        mIndicatorEndColor = ta.getInt(R.styleable.CommonTabLayout_tl_indicator_end_color, 0);
        ...
        mTextSelectSize = ta.getDimension(R.styleable.CommonTabLayout_tl_textSelectSize, mTextUnSelectSize);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                if (isGradientColor){
                    int[] colors = {mIndicatorStartColor,mIndicatorEndColor};
